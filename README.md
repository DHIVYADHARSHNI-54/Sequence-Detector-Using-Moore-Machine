...
`timescale 1ns / 1ps
module moore_sequence_ms(clk,reset,in,out);
 input clk;
 input reset;
 input in; 
 output reg out; 
...
### Testbench
```
module tb_moore_sequence_ms;
 reg clk, reset, in;
 wire out;
 moore_sequence_ms uut (clk,reset,in,out);
 initial 
 begin
 clk = 0;
 forever #5 clk = ~clk;
...
```
### Simulation Output
<img width="1918" height="1079" alt="image" src="https://github.com/user-attachments/assets/c6afe477-0d56-4b00-8162-3f3119f3071b" />
